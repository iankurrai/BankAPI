...
namespace BankAPI.Controllers
{
    ...
    public class AdminAPIController : ApiController
    {
        ...
        public IEnumerable<Ben> Get_Ben(int accno)
        {
            try
            {
                ...
                var res = from i in db.Beneficiaries
                          ...
                          select new Ben { Ben_AccNo = i.Ben_AccNo, User_AccNo = i.User_AccNo, Ben_NickName = i.Ben_NickName, Ben_Name = i.Ben_Name, Ben_Banktype = i.Ben_Banktype, IFSC_code = i.IFSC_code };
                return res;
            }
            catch (Exception e)
            {
        ...
        public bool Get_MailDetails(int Acc_No)
        {
            ...
            string password = res.State.Substring(2, 2) + res.Fname.Substring(0, 2) + '@' + res.Aadhar_No.ToString().Substring( 0, 5);
        ...
        [HttpGet]
        public string Get(int PSNo, string password)
        {
            try
            {
